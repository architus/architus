...
if 'logs-gateway-ingress' in enabled:
    if rust_hot_reload:
        ...
        local_resource('logs-gateway-ingress-compile', 'cargo build --manifest-path=logs/gateway-ingress/Cargo.toml',
                       deps=['logs/gateway-ingress/Cargo.toml', 'logs/gateway-ingress/Cargo.lock', 'logs/gateway-ingress/build.rs', 'logs/gateway-ingress/src', 'lib/ipc/proto/feature-gate.proto', 'logs/gateway-queue-lib/proto', 'lib/id-rs/Cargo.lock', 'lib/id-rs/Cargo.toml', 'lib/id-rs/src', 'lib/config-backoff-rs/Cargo.lock', 'lib/config-backoff-rs/Cargo.toml', 'lib/config-backoff-rs/src', 'lib/amqp-pool-rs/Cargo.lock', 'lib/amqp-pool-rs/Cargo.toml', 'lib/amqp-pool-rs/src'])
